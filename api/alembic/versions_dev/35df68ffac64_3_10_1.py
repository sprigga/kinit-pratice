...
Revision ID: 35df68ffac64
Revises: 5b25c17a90f9
Create Date: 2025-08-04 15:44:17.631215
...
revision = '35df68ffac64'
down_revision = '5b25c17a90f9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('Bpmin_it', sa.Column('serial_number', sa.String(length=50), nullable=True, comment='序號'))
...
def downgrade():
    ...
    op.alter_column('Bpmin_it', 'create_datetime',
               ...
               existing_comment='創建時間',
               existing_nullable=False)
    op.drop_column('Bpmin_it', 'serial_number')
    # ### end Alembic commands ###
