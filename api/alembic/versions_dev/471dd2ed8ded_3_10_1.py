...
Revision ID: 471dd2ed8ded
Revises: 532009d376d0
Create Date: 2025-08-11 14:07:37.095416
...
revision = '471dd2ed8ded'
down_revision = '532009d376d0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('Bpmin_it', sa.Column('datediff', sa.Float(), nullable=True, comment='處理天數'))
...
def downgrade():
    ...
    op.alter_column('Bpmin_it', 'create_datetime',
               ...
               existing_comment='創建時間',
               existing_nullable=False)
    op.drop_column('Bpmin_it', 'datediff')
    # ### end Alembic commands ###
