...
Revision ID: 5b25c17a90f9
Revises: 1afaf2bcc366
Create Date: 2025-08-04 13:18:10.521144
...
revision = '5b25c17a90f9'
down_revision = '1afaf2bcc366'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.alter_column('vadmin_auth_dept', 'create_datetime',
               ...
               existing_nullable=False)
    op.create_table('bpmin_it',
    sa.Column('it_manager', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=100), nullable=True, comment='IT經理'),
    sa.Column('dept', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=50), nullable=True, comment='部門'),
    sa.Column('apply_date', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=20), nullable=True, comment='申請日期'),
    sa.Column('extension', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=20), nullable=True, comment='分機號碼'),
    sa.Column('fillman', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=100), nullable=True, comment='填表人'),
    sa.Column('apply_item', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=200), nullable=True, comment='申請項目'),
    sa.Column('request_desc', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=500), nullable=True, comment='需求描述'),
    sa.Column('it_undertaker', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=100), nullable=True, comment='IT承辦人'),
    sa.Column('treatment', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=500), nullable=True, comment='處理方式'),
    sa.Column('create_user', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=30), nullable=True, comment='建立者工號'),
