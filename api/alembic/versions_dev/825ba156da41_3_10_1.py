...
Revision ID: 825ba156da41
Revises: 9a9746c02fd4
Create Date: 2025-08-08 09:43:04.394637
...
revision = '825ba156da41'
down_revision = '9a9746c02fd4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('Bpmin_it', sa.Column('sub_apply_item', sa.String(length=200), nullable=True, comment='子申請項目'))
...
def downgrade():
    ...
    op.alter_column('Bpmin_it', 'create_datetime',
               ...
               existing_comment='創建時間',
               existing_nullable=False)
    op.drop_column('Bpmin_it', 'sub_apply_item')
    # ### end Alembic commands ###
