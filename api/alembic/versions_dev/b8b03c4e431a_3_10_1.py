...
Revision ID: b8b03c4e431a
Revises: 43cf7573336e
Create Date: 2025-07-31 11:15:04.765736
...
revision = 'b8b03c4e431a'
down_revision = '43cf7573336e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('vadmin_system_settings_tab', 'update_datetime',
               ...
               existing_comment='更新時間',
               existing_nullable=False)
    op.add_column('vadmin_test', sa.Column('dialogue', sa.String(length=500), nullable=True, comment='對話內容'))
...
def downgrade():
    ...
    op.alter_column('vadmin_test', 'create_datetime',
               ...
               existing_comment='創建時間',
               existing_nullable=False)
    op.drop_column('vadmin_test', 'dialogue')
    op.alter_column('vadmin_system_settings_tab', 'update_datetime',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('CURRENT_TIMESTAMP'),
               existing_comment='更新時間',
