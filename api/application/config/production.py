...
SERVER 本機設定
"""
PROJECT_NAME = "tw_lottery"
SERVER_PORT = 8080
SERVER_TITLE = '冰點智能'
SERVER_DESCRIPTION = 'bMES管理系統'
...
MYSQL_USER = urllib.parse.quote_plus('root')
MYSQL_SERVER_IP = urllib.parse.quote_plus('127.0.0.1')
MYSQL_PORT = '3306'
MYSQL_PASSWORD = 'Y05os5352'
...
MONGO_DB_URL = f"mongodb+srv://{MONGO_DB_USERNAME}:{MONGO_DB_PASSWORD}@k-boss.i1bhh.mongodb.net/?retryWrites=true&w=majority&tls=true&tlsAllowInvalidCertificates=true"
