...
@app.get("/user/access/source", summary="用戶來源")
...
@app.get("/weekly/user/activity", summary="每周用户活躍量")
...
@app.get("/monthly/sales", summary="每月銷售額")
