...
class VadminRole(BaseModel):
    ...
    name: Mapped[str] = mapped_column(String(50), index=True, comment="名稱")
    role_key: Mapped[str] = mapped_column(String(50), index=True, comment="權限字符")
    data_range: Mapped[int] = mapped_column(Integer, default=4, comment="數據權限范围")
    ...
    is_admin: Mapped[bool] = mapped_column(Boolean, comment="是否為超级角色", default=False)
