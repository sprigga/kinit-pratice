...
#    类别管理
###########################################################
@app.get("/issue/categorys", summary="獲取类别列表")
...
@app.get("/issue/categorys/options", summary="獲取类别選擇項")
...
@app.post("/issue/categorys", summary="創建类别")
...
@app.delete("/issue/categorys", summary="批量刪除类别", description="硬刪除")
...
@app.get("/issue/categorys/{data_id}", summary="獲取类别信息")
...
@app.get("/issue/categorys/platform/{platform}", summary="獲取平台中的常见問题类别列表")
...
@app.delete("/issues", summary="批量刪除問题", description="硬刪除")
...
@app.put("/issues/{data_id}", summary="更新問题信息")
...
@app.get("/issues/{data_id}", summary="獲取問题信息")
...
@app.get("/issues/add/view/number/{data_id}", summary="更新常见問题查看次數+1")
