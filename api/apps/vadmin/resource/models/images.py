...
class VadminImages(BaseModel):
    ...
    __table_args__ = ({'comment': '圖片素材表'})

    filename: Mapped[str] = mapped_column(String(255), nullable=False, comment="原圖片名稱")
    image_url: Mapped[str] = mapped_column(String(500), nullable=False, comment="圖片链接")
