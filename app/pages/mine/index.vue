    ...
    <view class="header-section">
      <view class="flex padding justify-between">
        <view class="flex align-center">
          ...
          <view v-if="!name" class="login-tip" @click="handleToLogin"> 點擊登陸 </view>
        ...
        <view class="flex align-center" @click="handleToInfo">
          <text style="font-size: 30rpx">個人信息</text>
...
export default {
  ...
  methods: {
    ...
    handleLogout() {
      this.$modal.confirm('確定消除帳號並登出系統嗎？').then(() => {
