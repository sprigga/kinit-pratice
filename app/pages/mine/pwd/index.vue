<template>
  <view class="pwd-retrieve-container">
    <uni-forms ref="form" :value="form" label-width="80px">
      <uni-forms-item name="newPassword" label="新密碼">
        <uni-easyinput v-model="form.password" type="password" placeholder="請輸入新密碼" />
      </uni-forms-item>
      <uni-forms-item name="confirmPassword" label="確認密碼">
        <uni-easyinput v-model="form.password_two" type="password" placeholder="請輸入新密碼" />
      </uni-forms-item>
      ...
      rules: {
        password: {
          rules: [
            {
              required: true,
              errorMessage: '新密碼不能為空'
            },
            {
              minLength: 8,
              maxLength: 20,
              errorMessage: '長度在 8 到 20 個字符'
            }
          ]
        },
        password_two: {
