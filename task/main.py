...
class ScheduledTask:
    ...
    def run(self) -> None:
        ...
        logger.info("已成功启動程序，等待接收消息...")
        print("已成功启動程序，等待接收消息...")
    ...
    def close(self) -> None:
        """
        # pycharm 执行停止，該函数无法正常被执行，怀疑是因为阻塞导致或 pycharm 的强制退出导致
        # 报错导致得退出，会被执行
        关闭程序
        :return:
        """
