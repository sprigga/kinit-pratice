export default {
  ...
  searchDemo: {
    search: '查詢',
    searchDes: '基于 Form 组件二次封装，實現查询、重置功能',
    operate: '操作',
    change: '更改',
    grid: '栅格',
    button: '按钮',
  ...
  tableDemo: {
    ...
    restoreIndex: '還原序號',
    showSelections: '顯示多選',
    hiddenSelections: '隐藏多選',
    showExpandedRows: '顯示展開行',
    hiddenExpandedRows: '隐藏展開行',
    changeTitle: '修改標题',
    header: '頭部',
    selectAllNone: '全選/全不選',
    selectAll: '全選',
    delOrAddAction: '删除/添加操作列',
    showOrHiddenStripe: '顯示/隐藏斑馬纹',
    showOrHiddenBorder: '顯示/隐藏邊框',
    fixedHeaderOrAuto: '固定頭部/自動',
    getSelections: '獲取多選數據',
    preview: '封面',
    showOrHiddenSortable: '顯示/隐藏排序',
    videoPreview: '視頻預覽',
    cardTable: '卡片表格'
  },
  richText: {
