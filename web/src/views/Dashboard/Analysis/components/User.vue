...
<template>
  ...
  <ElRow :gutter="20" class="pt-4">
    <ElCol :xs="24" :sm="6" class="mb-2">
      <ElSkeleton :loading="loading" animated :rows="4">
        <div class="border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]">
          <div class="text-[#787a7d] text-[12px]">新增潛客數</div>
    ...
    <ElCol :xs="24" :sm="6" class="mb-2">
      <ElSkeleton :loading="loading" animated :rows="4">
        <div class="border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]">
          <div class="text-[#787a7d] text-[12px]">新增客户數</div>
    ...
    <ElCol :xs="24" :sm="6" class="mb-2">
      <ElSkeleton :loading="loading" animated :rows="4">
        <div class="border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]">
          <div class="text-[#787a7d] text-[12px]">新增會員數</div>
    ...
    <ElCol :xs="24" :sm="6" class="mb-2">
      <ElSkeleton :loading="loading" animated :rows="4">
        <div class="border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]">
          <div class="text-[#787a7d] text-[12px]">支付成功客户數</div>
    ...
    <ElCol :xs="24" :sm="12" class="mb-2">
      <ElSkeleton :loading="loading" animated :rows="4">
        <div class="border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]">
          <div>
            <div class="text-[#000] text-[12px]">會員分布情況</div>
    ...
    <ElCol :xs="24" :sm="12" class="mb-2">
      <ElSkeleton :loading="loading" animated :rows="4">
        <div class="border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]">
          <div class="text-[#000] text-[12px]">新增客户趨势</div>
    ...
    <ElCol :xs="24" :sm="12" class="mb-2">
      <ElSkeleton :loading="loading" animated :rows="4">
        <div class="border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]">
          <div class="text-[#000] text-[12px]">客户轉會員趨势</div>
    ...
    <ElCol :xs="24" :sm="12" class="mb-2">
      <ElSkeleton :loading="loading" animated :rows="4">
        <div class="border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]">
          <div class="text-[#000] text-[12px]">支付成功客户趨势</div>
