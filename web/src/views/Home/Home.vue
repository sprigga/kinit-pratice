      ...
      <ElCol :xs="24" :sm="12" :md="8">
        <ElCard shadow="hover" class="pb-30px">
          ...
          <div class="pl-20px pt-30px">
            ...
            <div class="leading-relaxed">
              <span class="pl-10px w-80px inline-block">職稱:</span>
              <span class="pl-10px">{{ user.nickname }}</span>
            </div>
            <div class="leading-relaxed">
              <span class="pl-10px w-80px inline-block">帳號:</span>
            ...
            <div class="leading-relaxed">
              <span class="pl-10px w-80px inline-block">創建時間:</span>
      ...
      <ElCol :xs="24" :sm="12" :md="16">
        <ElCard shadow="hover">
          <ElTabs v-model="activeName">
            ...
            <ElTabPane label="修改密碼" name="password">
              <PasswordWrite />
            </ElTabPane>
          </ElTabs>
        </ElCard>
