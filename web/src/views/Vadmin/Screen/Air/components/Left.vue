    ...
    <div class="main-content">
      <BorderBox11 title="室内甲醛">
        <div class="data-view">
          ...
          <span class="data-desc">提示：低于80ug/m³適合長期居住</span>
        </div>
      </BorderBox11>
      <BorderBox11 title="室内PM2.5">
        <div class="data-view">
          <span class="data-title">{{ props.leftData.pm25 }}ug/m³</span>
          <span class="data-desc">提示：低于75ug/m³適合長期居住</span>
        </div>
      </BorderBox11>
      <BorderBox11 title="室内溫度">
        <div class="data-view">
          <span class="data-title">{{ props.leftData.temp }}°C</span>
          <span class="data-desc">提示：當前室外溫度為25°C</span>
        </div>
      </BorderBox11>
      <BorderBox11 title="室内濕度">
        <div class="data-view">
          <span class="data-title">{{ props.leftData.hum }}%RH</span>
          <span class="data-desc">提示：當前室外濕度為38%RH</span>
        </div>
      </BorderBox11>
    </div>
  </div>
