    ...
    slots: {
      default: (data: any) => {
        ...
        const toCopy = async (value: string) => {
          // 複製功能打包部署到線上後，需要線上地址使用 https 才可使用
  ...
  <ContentWrap>
    ...
    >
      <template #toolbar>
        <ElRow :gutter="10">
          <ElCol :span="1.5">
            <BaseButton type="primary" @click="addAction">新增字典類型</BaseButton>
          </ElCol>
          <ElCol :span="1.5">
            <BaseButton type="danger" @click="clearCurrentRow">清除選擇</BaseButton>
          </ElCol>
        </ElRow>
      </template>
    </Table>
